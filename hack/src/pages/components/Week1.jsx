        ...
        { NEWWEEK.map((day,id) =>(
                <th  key={id}>
                    ...
                    <p id="a">{day.day}<sub onSubmit={handleSubmit}>
                        <div>
                        <select value={userEvent} onSelect={(e)=> setUserEvent({EvDate: day.day, Ev:e.currentTarget.value, dOW: day.dow})}>
                        <option value="cour">+</option>
                        <option value="ДЗ" onClick={(e)=>handleSubmit(e)}>ДЗ</option>
                        <option value="РК" onClick={(e)=>handleSubmit(e)}>РК</option>
                        <option value="КР" onClick={(e)=>handleSubmit(e)}>КР</option>
                        <option value="Другое" onClick={(e)=>handleSubmit(e)}>Другое</option>
